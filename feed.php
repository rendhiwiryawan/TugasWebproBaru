    ...
    <main id="feed">
        <?php foreach ($post as $foto):  ?>        
            ...
            <header class="photo__header">
                <img src="images/avatar_user/rawiryawan/1.jpg" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author">rawiryawan</span>
                    <span class="photo__location">Bandung</span>
                </div>
            </header>
            <img src="images/avatar_user/rawiryawan/1.jpg" />
            <div class="photo__info">
                ...
                <ul class="photo__comments">
                    <li class="photo__comment">
                        <span class="photo__comment-author"><?= $usrnm; ?></span><?= $foto['caption']; ?>
                    </li>
                </ul>
