...
<?php 
    ...
    $result = mysqli_query($conn, "SELECT * FROM profil WHERE username = '$usrnm'");
    ...
    $name = $profile['nama'];
    $email = $profile['email'];
    $phonenumb = $profile['no_hp'];
    $jkelamin = $profile['jeniskelamin'];
    ...
    if (isset($_POST['submit'])) {
        ...
        $name = $profile['nama'];
        $email = $profile['email'];
        $phonenumb = $profile['nohp'];
        $jkelamin = $profile['jeniskelamin'];

        $update = mysqli_query($conn, "UPDATE profil SET username='$username', website='$web', biography='$bio', nama ='$name', email='$email', no_hp='$phonenumb', jeniskelamin='$jeklamin' WHERE username ='$usrnm' ");
